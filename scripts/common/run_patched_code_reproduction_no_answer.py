...
RESULTS_DIR = (
    PROJECT_ROOT / "results" / "github" / "ablation" / "patched_code" / "no_answer"
)
...
GENERATOR_ANSWER_PLACEHOLDER = "[No accepted answer available]"
REVIEWER_ANSWER_PLACEHOLDER = "[No accepted answer available]"
...
def run_for_model(MODEL_NAME: str, DATA_PATH: Path):
    ...
    log_section(
        ...
        "CONFIG",
        {
            ...
            "GENERATOR_HAS_ANSWER": False,
            "REVIEWER_HAS_ANSWER": True,
        },
    )
    ...
    for ablation in ABLATIONS:
        for idx, row in dataset.iterrows():
            ...
            question = get_optional(row, "question_body") or ""
            generator_answer = GENERATOR_ANSWER_PLACEHOLDER
            reviewer_answer = (
                get_optional(row, "accepted_answer_body") or REVIEWER_ANSWER_PLACEHOLDER
            )
