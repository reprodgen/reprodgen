...
class BuggyCodeIntentJudge:
    """
    Judges whether a generated buggy code intent accurately captures
    the user's intended functional goal as expressed in the
    ...
    def __init__(
        ...
        prompt_def = loader.load("judge_buggy_code_intent.yaml")
