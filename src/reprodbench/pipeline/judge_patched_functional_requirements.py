...
class PatchedFunctionalRequirementsJudge:
    """
    Judges whether generated patched functional requirements accurately
    capture the corrected functional behavior of the code as described
    ...
    def __init__(
        ...
        prompt_def = loader.load("judge_patched_functional_requirements.yaml")
    ...
    def judge(
        ...
        *,
        ...
        # print("Patched Functional Requirements Judge LLM output:\n", raw)
